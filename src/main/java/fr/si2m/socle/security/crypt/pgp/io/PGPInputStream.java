package fr.si2m.socle.security.crypt.pgp.io;
...
import fr.si2m.socle.security.crypt.pgp.rfc4880.types.CompressionAlgorithmType;
import fr.si2m.socle.security.crypt.pgp.rfc4880.types.HashAlgorithmType;
import fr.si2m.socle.security.crypt.pgp.rfc4880.types.MessageFormatType;
import fr.si2m.socle.security.crypt.pgp.rfc4880.types.PublicKeyAlgorithmType;
import fr.si2m.socle.security.crypt.pgp.rfc4880.types.SignatureType;
import fr.si2m.socle.security.crypt.pgp.tools.PGPUtils;
...
public class PGPInputStream extends InputStream {
	...
	private void populatePrivateKey(PGPEncryptedDataList pEncryptedDataList) throws PGPException, IllegalArgumentException {
		...
		while ((this.privateKey == null) && lIterator.hasNext()) {
			this.encryptedData = (PGPPublicKeyEncryptedData) lIterator.next();
			this.report.dataIntegrityProtected = this.encryptedData.isIntegrityProtected();
			this.privateKey = PGPUtils.findPrivateKey(this.secretKeyRing, this.encryptedData.getKeyID(), this.passphrase);
		}
