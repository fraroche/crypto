package fr.si2m.socle.security.crypt.pgp.tools;
...
import fr.si2m.socle.security.crypt.pgp.rfc4880.types.SymmetricKeyAlgorithmType;
...
public class PGPUtils {
	 ...
	 * 
	 * @param pPubKeyringCollection receiver public key ring
	 * @return
	 */
	public static PGPPublicKey findPublicKeyForEncryption(final PGPPublicKeyRingCollection pPubKeyringCollection) {
		return findPublicKey(pPubKeyringCollection, false);
	}

	/**
	 * Retrieve the sender's suitagle public key to check the signature
	 * 
	...
	public static PGPPublicKey findPublicKeyForSignChecking(final PGPPublicKeyRingCollection pPubKeyringCollection) {
		return findPublicKey(pPubKeyringCollection, true);
	}
	/**
	 * Description:
	 * 
