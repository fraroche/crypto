package fr.si2m.socle.security.crypt.pgp.test;
...
import fr.si2m.socle.security.crypt.pgp.conf.FilePath;
import fr.si2m.socle.security.crypt.pgp.io.PGPInputStream;
import fr.si2m.socle.security.crypt.pgp.io.PGPOutputStream;
import fr.si2m.socle.security.crypt.pgp.io.PGPStreamFactory;
...
public class TestCase {
	...
	public static void testEncrypt(final String pInFilePath, final String pOutFilePath, final String pSecKeyFilePath, final String pPubKeyFilePath, final char[] pPassphrase, 
	...
	public void testEncryptDecrypt_bob2alice_Ciphered() {
		try {
			testEncrypt(FilePath.BOB_2_ALICE_TXT, FilePath.BOB_2_ALICE_CIPHERED, null, FilePath.PUB_KEY_ALICE, null, false, false);
	...
	public void testEncryptDecrypt_bob2alice_CipheredArmored() {
		try {
			testEncrypt(FilePath.BOB_2_ALICE_TXT, FilePath.BOB_2_ALICE_CIPHERED_ARMORED, null, FilePath.PUB_KEY_ALICE, null, true, false);
	...
	public void testEncryptDecrypt_bob2alice_CipheredSigned() {
		try {
			testEncrypt(FilePath.BOB_2_ALICE_TXT, FilePath.BOB_2_ALICE_CIPHERED_SIGNED, FilePath.SEC_KEY_BOB, FilePath.PUB_KEY_ALICE, PASSPHRASE_BOB.toCharArray(), false, false);
	...
	public void testEncryptDecrypt_bob2alice_CipheredSignedArmored() {
		try {
			testEncrypt(FilePath.BOB_2_ALICE_TXT, FilePath.BOB_2_ALICE_CIPHERED_SIGNED_ARMORED, FilePath.SEC_KEY_BOB, FilePath.PUB_KEY_ALICE, PASSPHRASE_BOB.toCharArray(), true, false);
	...
	public void testEncryptDecrypt_bob2alice_CompressedCiphered() {
		try {
			testEncrypt(FilePath.BOB_2_ALICE_TXT, FilePath.BOB_2_ALICE_COMPRESSED_CIPHERED, null, FilePath.PUB_KEY_ALICE, null, false, true);
	...
	public void testEncryptDecrypt_bob2alice_CompressedCipheredArmored() {
		try {
			testEncrypt(FilePath.BOB_2_ALICE_TXT, FilePath.BOB_2_ALICE_COMPRESSED_CIPHERED_ARMORED, null, FilePath.PUB_KEY_ALICE, null, true, true);
	...
	public void testEncryptDecrypt_bob2alice_CompressedCipheredSigned() {
		try {
			testEncrypt(FilePath.BOB_2_ALICE_TXT, FilePath.BOB_2_ALICE_COMPRESSED_CIPHERED_SIGNED, FilePath.SEC_KEY_BOB, FilePath.PUB_KEY_ALICE, PASSPHRASE_BOB.toCharArray(), false, true);
	...
	public void testEncryptDecrypt_bob2alice_CompressedCipheredSignedArmored() {
		try {
			testEncrypt(FilePath.BOB_2_ALICE_TXT, FilePath.BOB_2_ALICE_COMPRESSED_CIPHERED_SIGNED_ARMORED, FilePath.SEC_KEY_BOB, FilePath.PUB_KEY_ALICE, PASSPHRASE_BOB.toCharArray(), true, true);
